...
const styles = StyleSheet.create({
  ...
  desc: { fontFamily: 'Amiri_400Regular', fontSize: 15, color: Colors.inkMid, lineHeight: 24, marginBottom: 10 },
  ...
  tableCell: { flex: 1, padding: 8, fontFamily: 'Amiri_400Regular', fontSize: 11, color: Colors.inkMid },
  headerCell: { color: Colors.parchment, fontWeight: '600' },
  name: { fontFamily: 'Amiri_400Regular', fontSize: 17, color: Colors.ink, marginBottom: 2 },
